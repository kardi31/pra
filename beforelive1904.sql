...
INSERT INTO `advertisment_category_group_translation` (`id`, `title`, `slug`, `content`, `lang`) VALUES
	...
	(1, 'Job', 'job', NULL, 'en'),
	(2, 'Accomodation', 'accomodation', NULL, 'en'),
	(3, 'Social', 'social', NULL, 'en'),
	(4, 'Automotive', 'automotive', NULL, 'en'),
	(5, 'Home', 'home', NULL, 'en'),
	(6, 'Computers & Electronics', 'computers-electronics', NULL, 'en'),
	(7, 'For children', 'for-children', NULL, 'en'),
	(8, 'Other for sale', 'other-for-sale', NULL, 'en'),
	(9, 'Free local classifieds', 'free-local-classifieds', NULL, 'en'),
	(10, 'Buy', 'buy', NULL, 'en'),
	(11, 'Common passage', 'common-passage', NULL, 'en'),
	(12, 'Other', 'other', NULL, 'en');
...
CREATE TABLE IF NOT EXISTS `agent_agent` (
  ...
  `logo_root_id` int(11) DEFAULT NULL,
  `ad_root_id` int(11) DEFAULT NULL,
...
INSERT INTO `agent_agent_category` (`agent_id`, `category_id`, `created_at`, `updated_at`) VALUES
	(1, 5, '2016-04-18 14:37:04', '2016-04-18 14:37:04');
...
INSERT INTO `agent_agent_translation` (`id`, `lang`, `description`) VALUES
	(1, 'pl', 'Nasza Kancelaria Podatkowa powstała pierwsza na lokalnym rynku.\r\n\r\nDzięki rzetelności i fachowości już od ponad 25 lat pomagamy naszym Klientom.\r\nProfesjonalnie zajmiemy się dla Państwa rozliczeniami, ewidencjami i deklaracjami.\r\nJesteśmy blisko i rozumiemy Państwa potrzeby.\r\nJeśli chcą Państwo uzyskać więcej informacji, zapraszamy do naszej nowej siedziby na ul. Krakowskiej 30 w Krzeszowicach.'),
	(1, 'en', 'Nasza Kancelaria Podatkowa powstała pierwsza na lokalnym rynku.\r\n\r\nDzięki rzetelności i fachowości już od ponad 25 lat pomagamy naszym Klientom.\r\nProfesjonalnie zajmiemy się dla Państwa rozliczeniami, ewidencjami i deklaracjami.\r\nJesteśmy blisko i rozumiemy Państwa potrzeby.\r\nJeśli chcą Państwo uzyskać więcej informacji, zapraszamy do naszej nowej siedziby na ul. Krakowskiej 30 w Krzeszowicach.');
...
-- Dumping data for table pracownik.agent_category: 80 rows
...
-- Dumping data for table pracownik.agent_category_translation: 162 rows
...
INSERT INTO `agent_category_translation` (`id`, `lang`, `title`, `slug`) VALUES
	...
	(5, 'pl', 'Biura rachunkowe', 'biura-rachunkowe'),
...
INSERT INTO `branch_branch` (`id`, `agent_id`, `office_name`, `office_link`, `address`, `town`, `county`, `country`, `postcode`, `phone`, `fax`, `email`, `url`, `view`, `approved`, `rating`, `points`, `customer_satisfaction`, `votes`, `rank`, `lat`, `lng`, `photo_root_id`, `facebook`, `twitter`, `premium_support`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 1, 'Krzeszowice', 'krzeszowice', 'ul. Krakowska 30', 'Krzeszowice', 'Małopolskie', NULL, '32-065', '12 258 16 30', NULL, 'agnieszkamirek1@gmail.com', NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, '50.1341479', '19.6392219', NULL, '', '', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07', NULL);
...
INSERT INTO `branch_opening_hours` (`id`, `branch_id`, `day_id`, `from`, `to`, `closed`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '09:00:00', '17:30:00', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(2, 1, 2, '09:00:00', '17:30:00', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(3, 1, 3, '09:00:00', '17:30:00', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(4, 1, 4, '09:00:00', '17:30:00', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(5, 1, 5, '09:00:00', '17:30:00', 0, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(6, 1, 6, NULL, NULL, 1, '2016-04-18 12:42:07', '2016-04-18 12:42:07'),
	(7, 1, 7, NULL, NULL, 1, '2016-04-18 12:42:07', '2016-04-18 12:42:07');
...
-- Dumping data for table pracownik.branch_update_opening_hours: 0 rows
...
INSERT INTO `branch_update_opening_hours` (`id`, `update_id`, `day_id`, `from`, `to`, `closed`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, '09:00:00', '17:30:00', 0, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(2, 2, 2, '09:00:00', '17:30:00', 0, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(3, 2, 3, '09:00:00', '17:30:00', 0, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(4, 2, 4, '09:00:00', '17:30:00', 0, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(5, 2, 5, '09:00:00', '17:30:00', 0, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(6, 2, 6, NULL, NULL, 1, '2016-04-18 12:41:40', '2016-04-18 12:41:40'),
	(7, 2, 7, NULL, NULL, 1, '2016-04-18 12:41:40', '2016-04-18 12:41:40');
...
INSERT INTO `media_photo` (`id`, `offset`, `filename`, `title`, `crop_data`, `root_id`, `lft`, `rgt`, `level`) VALUES
	...
	(381, '211486400', '2015-02-03-1659.jpg', '2015-02-03-1659', NULL, 381, 1, 2, 0),
	(382, '211486400', '2015-02-03-1659-1.jpg', '2015-02-03-1659', NULL, 382, 1, 2, 0);
...
-- Dumping data for table pracownik.staff_update: 0 rows
...
INSERT INTO `user_user` (`id`, `fb_id`, `first_name`, `last_name`, `email`, `username`, `salt`, `password`, `role`, `token`, `active`, `agent_id`, `branch_id`, `staff_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, NULL, 'Tomek', 'Kardas', 'admin', 'admin', '7d9d989f91c3bd74e4a047505a6b02e5', 'b74d8dcadb0ea2fc613471c9a51424f7', 'admin', 'b176da66aecea8e81ad5b125118dba36', 1, NULL, NULL, NULL, '0000-00-00 00:00:00', '2016-04-18 12:32:25', NULL);
