...
class Banner_Form_Banner extends Admin_Form {
    ...
    public function init() {
        ...
        $bannerService = MF_Service_ServiceBroker::getInstance()->getService('Banner_Service_Banner');
       ...
       $file = $this->createElement('file', 'photo');
        ...
        foreach($bannerService->getAllPositions() as $key => $position_elem):
            $position->addMultiOption($key,$position_elem);
        endforeach;
