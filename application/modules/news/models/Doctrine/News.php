...
class News_Model_Doctrine_News extends News_Model_Doctrine_BaseNews
{
     public static $newsPhotoDimensions = array(
        ...
        '160x117' => 'Strona glowna - 2 zdjecie',
//        '74x74' => 'Najnowsze informacje(74x74)',
        '630x250' => 'Strona główna - 1 zdjecie',
        '850x380' => 'Główne zdjęcie (850x380)',
        '59x42' => 'Kategoria - pozostałe newsy(59x42)',
        '210x140' => 'News - lista(210x140)',
        '250x150' => 'News - 250x150',
        '677x200' => 'News - kategorie',
