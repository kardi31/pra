 ...
 */
abstract class Job_Model_Doctrine_BaseJob extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('job_job');
    ...
    {
        parent::setUp();
        $this->hasMany('Job_Model_Doctrine_Application as Applications', array(
             'local' => 'id',
             'foreign' => 'job_id'));
