...
/**
 * Branch_Model_Doctrine_BaseAreaCovered
 * 
 ...
 */
abstract class Branch_Model_Doctrine_BaseAreaCovered extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('branch_area_covered');
