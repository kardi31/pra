var App = function() {
    var t, e = !1,
        ...
        b = function() {
            if ($().uniform) {
                var t = $("input[type=checkbox]:not(.no-uniform,.toggle, .md-check, .md-radiobtn, .make-switch, .icheck), input[type=radio]:not(.toggle, .md-check, .md-radiobtn, .star, .make-switch, .icheck)");
