var Layout = function() {
    var e = "layouts/layout2/img/",
        ...
        i = function() {
            ...
            if (s.hasClass("page-footer-fixed") === !0 && s.hasClass("page-sidebar-fixed") === !1) {
                ...
                if (s.hasClass("page-sidebar-fixed")) e = r(), s.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight());
                else {
                    var n = $(".page-header").outerHeight(),
                        d = $(".page-footer").outerHeight();
                    e = App.getViewPort().width < t ? App.getViewPort().height - n - d : i.height() + 20, e + n + d <= App.getViewPort().height && (e = App.getViewPort().height - n - d)
                }
    ...
    return {
        ...
        initSidebar: function() {
            d(), o(), l(), App.isAngularJsApp() && s("match"), App.addResizeHandler(d)
        },
